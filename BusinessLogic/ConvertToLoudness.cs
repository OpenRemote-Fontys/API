...
{
    public class ProcessingFrequencySpread
    {

        public float CalculateLoudness(Dictionary<string, int> frequencyReadings)
        {
        ...
        private int[] AdjustedForHearing(int[] frequencies, int[] frequencyValues)
        {
        ...
        private float ConvertToLoudness(int[] values)
        {
            return values.Sum() / 1.0f;
        }
    }
}